          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            {loading ? (
              Array.from({ length: 5 }).map((_, i) => (
                <div key={i} style={{ height: 140, borderRadius: 12, background: '#e8eaed', animation: 'pulse 1.5s infinite' }}/>
              ))
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ display: 'flex', alignItems: 'flex-start',
                      ...
                      <div style={{ flexShrink: 0, textAlign: 'right' }}>
                        <div style={{ color: '#d97706', fontSize: 11 }}>{starRating(c.rating)}</div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6, marginBottom: 12 }}>
              {[0, 1, 2].map(i => (
                <div key={i} style={{
                  ...
                  border: '1px ' + (selected[i] ? 'solid rgba(0,132,137,0.25)' : 'dashed rgba(188,202,195,0.5)'),
            ...
            {selected.length >= 2 ? (
              <a href={'/compare?ids=' + selected.map(c => c.slug).join(',')}
                style={{
                  ...
                  borderRadius: 8, background: '#008489', color: '#ffffff',
                ...
                <div style={{
                  ...
                  {selected.map(c => (
                    <div key={c.id} style={{
                      ...
                      <div style={{ width: 28, height: 28, borderRadius: 6, background: '#f0f2f5',
